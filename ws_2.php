<?php
//endpoint: https://api.spotify.com/v1/playlists/%7Bplaylist_id%7D/followers/contains
//consuming a ws with php curl
//response: json in array format
try {
    $header_accept = "Accept: application/json";
    $header_content_type = "Content-Type: application/json";
    $header_authorization = "Authorization: Bearer BQCyU14ifx8SZwoGk7gYtJGVDCO9ts7ftwMZwUcR7B3krd0kbNj5gGh07kf1qhE4HRumP4RKTLWOHJjymEBNTuX3GCrOQZXpF_yYD3hzzz5Jc4B7T-elnXbSHG6s1E-pdiZ5h2iEFTb-STXyHpSybVPkpPGntZ4";
